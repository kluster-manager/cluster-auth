...
import (
	...
	authenticationv1alpha1 "open-cluster-management.io/cluster-auth-manager/api/authentication/v1alpha1"
	authorizationv1alpha1 "open-cluster-management.io/cluster-auth-manager/api/authorization/v1alpha1"
	authenticationcontroller "open-cluster-management.io/cluster-auth-manager/internal/controller/authentication"
	authorizationcontroller "open-cluster-management.io/cluster-auth-manager/internal/controller/authorization"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e151a618.k8s.appscode.com",
