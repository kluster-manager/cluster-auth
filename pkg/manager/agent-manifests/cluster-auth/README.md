...
$ helm repo update
$ helm search repo appscode/cluster-auth-agent --version=v2026.2.16
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2026.2.16
```
...
```bash
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2026.2.16 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2026.2.16 --values values.yaml
```
