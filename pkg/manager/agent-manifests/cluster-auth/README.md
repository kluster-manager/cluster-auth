...
$ helm repo update
$ helm search repo appscode/cluster-auth-agent --version=v2025.4.30
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2025.4.30
```
...
```bash
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2025.4.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i cluster-auth appscode/cluster-auth-agent -n open-cluster-management-cluster-auth --create-namespace --version=v2025.4.30 --values values.yaml
```
